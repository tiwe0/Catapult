...
@onready var _installed_list =  $SoundpacksVBox/HBox/Installed/InstalledList
@onready var _available_list =  $SoundpacksVBox/HBox/Downloadable/AvailableList
@onready var _btn_delete =      $SoundpacksVBox/HBox/Installed/BtnDelete
@onready var _btn_install =     $SoundpacksVBox/HBox/Downloadable/BtnInstall
@onready var _dlg_confirm_del = $SoundpacksVBox/ConfirmDelete
@onready var _dlg_manual_dl =   $SoundpacksVBox/ConfirmManualDownload
@onready var _dlg_file =        $SoundpacksVBox/InstallFromFileDialog
@onready var _cbox_stock =      $SoundpacksVBox/HBox/Installed/ShowStock
