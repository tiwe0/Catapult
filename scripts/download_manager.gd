...
func _enter_tree() -> void:
    ...
    _http.connect("request_completed", _on_HTTPRequest_request_completed)
...
func download_file(url: String, target_dir: String, target_filename: String) -> void:
    ...
    _current_file_path = target_dir + str(target_filename)
...
func _on_HTTPRequest_request_completed(_result: int, _response_code: int,
    ...
    if DirAccess.dir_exists_absolute(_current_file_path):
